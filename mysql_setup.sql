...
CREATE USER 'gigdbdmn'@'192.168.56.%' IDENTIFIED BY 'PASS';
...
CREATE USER 'admin'@'192.168.56.%' IDENTIFIED BY 'PASS';
GRANT ALL PRIVILEGES ON MusicStore.* TO 'admin'@'192.168.56.%' WITH GRANT OPTION;
FLUSH PRIVILEGES;

--Create development accounts.
CREATE USER 'devel01'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel02'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel03'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel04'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel05'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel06'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel07'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel08'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel09'@'192.168.56.%' IDENTIFIED BY 'PASS';
CREATE USER 'devel10'@'192.168.56.%' IDENTIFIED BY 'PASS';
